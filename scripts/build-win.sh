#!/usr/bin/env bash
# ── Build script for Windows (run from project root) ──
# Prereqs: Node.js 18+, npm
# NOTE: Must be run as Administrator (electron-builder needs elevated
#       permissions for code-signing cache on Windows)
set -euo pipefail
...
echo "═══════════════════════════════════════════════"
echo "  Unweave — Windows Build Pipeline"
echo "═══════════════════════════════════════════════"
...
export WIN_CSC_LINK=""
# Pre-create winCodeSign cache to avoid electron-builder mkdir bug on Windows
